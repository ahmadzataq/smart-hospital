...
st.markdown("""
<!-- COLOR1 -->
<div style="background:linear-gradient(135deg,#fda3a3 0%,#b3e89d 60%,#f35050 100%);
    ...
    <div style="font-size:18px;color:rgba(255,255,255,0.85);font-weight:400;">
        Find the Right Department for Your Symptomps
    </div>
</div>
""", unsafe_allow_html=True)
...
with st.form("triage_form"):
    ...
    st.markdown("""
    <!-- COLOR2 -->
    <div style="background:#f9bdbd;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#b1ffa6;color:white;border-radius:8px;
                         padding:4px 10px;font-size:12px;font-weight:600;">1</span>
            <span style="font-size:16px;font-weight:600;color:#121213;">What are your main symtomps</span>
    ...
    st.markdown("""
    <!-- COLOR3 -->
    <div style="background:#ffacac;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#c5ffbd;color:white;border-radius:8px;
    ...
    st.markdown("""
    <!-- COLOR4 -->
    <div style="background:#feacac;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#b7ffad;color:white;border-radius:8px;
    ...
    st.markdown("""
    <!-- COLOR5 -->
    <div style="background:#fdb7b7;border:1px solid #cbdc0d;border-radius:14px;
                padding:20px 24px;margin-bottom:20px;">
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:4px;">
            <span style="background:#b3ffa9;color:white;border-radius:8px;
